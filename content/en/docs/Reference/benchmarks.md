...
Benchmarks are generated using the Tensil compiler. Each instruction is evaluated against a latency model to compute expected execution time. Actual results may therefore differ somewhat from the numbers listed here. [Help us](https://github.com/ankur-gupta-29/tensil/blob/main/tools/src/tensil/tools/compiler/BackendStream.scala#L289) improve the latency model!
